...
#
# Generated Mon Oct 10 17:42:39 2016 by generateDS.py version 2.23a.
#
# Command line options:
#   ('-o', 'sdn_advanced.py')
#   ('-s', 'sdn_advanced_subs.py')
#
# Command line arguments:
#   sdn_advanced.xsd
#
# Command line:
#   generateDS.py -o "sdn_advanced.py" -s "sdn_advanced_subs.py" sdn_advanced.xsd
#
